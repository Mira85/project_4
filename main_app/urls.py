...
urlpatterns = [
    ...
    path('point_of_interest/<int:point_of_interest_id>/update_review/<int:review_id>', views.update_review, name='update_review'),
    path('point_of_interest/<int:point_of_interest_id>/delete_review/<int:review_id>', views.delete_review, name='delete_review'),
]
